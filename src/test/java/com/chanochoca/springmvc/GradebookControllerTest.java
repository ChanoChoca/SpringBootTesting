package com.chanochoca.springmvc;
...
@Transactional //usaremos JPA Entity Manager
public class GradebookControllerTest {
    ...
    public static void setup() {
        ...
        request.setParameter("lastname",  "Caprioli");

        request.setParameter("emailAddress", "juan.caprioli@chanoschool.com");
    }
    ...
    public void getStudentsHttpRequest() throws Exception {
        ...
        student.setLastname("Caprioli");
        student.setEmailAddress("juan.caprioli@chanoschool.com");
    ...
    public void createStudentHttpRequest() throws Exception {
        student.setFirstname("Juan");
        student.setLastname("Caprioli");
        student.setEmailAddress("juan_caprioli@chanoschool.com");
        ...
        CollegeStudent verifyStudent = studentDao.findByEmailAddress("juan_caprioli@chanoschool.com");
    ...
    public void studentInformationHttpRequest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/studentInformation/{id}", 1))
                ...
                .andExpect(jsonPath("$.firstname", is("Chano")))
                .andExpect(jsonPath("$.lastname", is("Choca")))
                .andExpect(jsonPath("$.emailAddress", is("chano.choca@example.com")));
    }
    ...
    @Test
    public void createANonValidGradeHttpRequestGradeTypeDoesNotExistEmptyReponse() throws Exception {

        this.mockMvc.perform(MockMvcRequestBuilders.post("/grades")
                .contentType(MediaType.APPLICATION_JSON)
                .param("grade", "85.00")
                .param("gradeType", "literature") //invalid grade type / subject
                .param("studentId", "1"))
                .andExpect(status().is4xxClientError())
                .andExpect(jsonPath("$.status", is(404)))
                .andExpect(jsonPath("$.message", is("Student or Grade was not found")));
