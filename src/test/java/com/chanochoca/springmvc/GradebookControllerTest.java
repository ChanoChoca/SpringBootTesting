...
public class GradebookControllerTest {
    ...
    /* BeforeAll and methods must be declared as static */
    @BeforeAll
    public static void setup() {
        request = new MockHttpServletRequest();
        request.setParameter("firstname", "Juan");
        request.setParameter("lastname", "Caprioli");
        request.setParameter("emailAddress", "juan.caprioli@luv2code_school.com");
    }
    ...
    public void getStudentsHttpRequest() throws Exception {
        ...
        CollegeStudent studentTwo = new GradebookCollegeStudent("Juan", "Caprioli",
                "juan_caprioli@luv2code_school.com");
        ...
        System.out.println("\n\n\n");
        for (CollegeStudent c: studentCreateServiceMock.getGradebook()) {
            System.out.println(c);
        } /* No devuelve nada (no se ha implementado `getGradeBook()`)  */

        /* cuando se llame a `getGradebook()`, debe devolver la lista `collegeStudentList` */
    ...
    public void createStudentHttpRequest() throws Exception {
        ...
        CollegeStudent verifyStudent = studentDao.
                findByEmailAddress("juan.caprioli@luv2code_school.com");
    ...
    public void createAValidGradeHttpRequestDoesNotExistEmptyResponse() throws  Exception {
        MvcResult mvcResult = this.mockMvc.perform(post("/grades")
                ...
                .param("studentId", "0")) //0 doesn't exist
                .andExpect(status().isOk()).andReturn();
    ...
    public void createANonValidGradeHttpRequestGradeTypeDoesNotExistEmptyResponse() throws Exception {
        ...
        MvcResult mvcResult = this.mockMvc.perform(post("/grades")
                .contentType(MediaType.APPLICATION_JSON)
                .param("grade", "85.00")
                .param("gradeType", "literature") //literature doesn't exist
                .param("studentId", "1"))
                .andExpect(status().isOk()).andReturn();
    ...
    public void deleteAValidGradeHttpRequestStudentIdDoesNotExistEmptyResponse() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders
                .get("/grades/{id}/{gradeType}", 2, "math")) //uriVars(id) doesn't exist
                .andExpect(status().isOk()).andReturn();
