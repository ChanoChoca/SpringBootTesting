...
public class StudentAndGradeServiceTest {
    ...
    public void createStudentService() {
        ...
        studentService.createStudent("Juan", "Caprioli", "juan.caprioli@example.com");

        CollegeStudent student = studentDao.findByEmailAddress("juan.caprioli@example.com");

        assertEquals("juan.caprioli@example.com", student.getEmailAddress(), "find by email");
    }
    ...
    public void studentInformationService() {
        ...
        assertEquals("Chano", gradebookCollegeStudentTest.getFirstname());
        assertEquals("Choca", gradebookCollegeStudentTest.getLastname());
        assertEquals("chano.choca@example.com", gradebookCollegeStudentTest.getEmailAddress());
