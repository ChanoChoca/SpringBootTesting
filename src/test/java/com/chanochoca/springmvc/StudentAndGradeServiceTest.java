...
public class StudentAndGradeServiceTest {
    ...
    public void createStudentService() {
        ...
        studentService.createStudent("Juan", "Caprioli",
                "juan.caprioli@chanoschool.com");

        CollegeStudent student = studentDao.
                findByEmailAddress("juan.caprioli@chanoschool.com");

        assertEquals("juan.caprioli@chanoschool.com",
...
//        Verify there is grades
    ...
    public void studentInformation() {
        ...
        assertEquals("Doe", gradebookCollegeStudent.getLastname());
        assertEquals("john.doe@outlook.com", gradebookCollegeStudent.getEmailAddress());
